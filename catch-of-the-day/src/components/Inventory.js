...
class Inventory extends React.Component {
    ...
    handleChange(e, key) {
        ...
        // take a copy of that fish and update it in the new data
        const updatedFish = {
            ...fish,
    ...
    renderLogin() {
        return (
            <nav className="login">
                ...
                <button className="github" onClick={() => this.authenticate('github')}>Log In with 
                    Github</button>
                <button className="facebook" onClick={() => this.authenticate('facebook')}>Log In with 
                    Facebook</button>
            </nav>
        )
    }
